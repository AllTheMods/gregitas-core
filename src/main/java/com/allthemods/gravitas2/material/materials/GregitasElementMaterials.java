...
public class GregitasElementMaterials {
    ...
    public static void init() {
        WeaponsGradeNaquadah = new Material.Builder(GregitasCore.id("weapons_grade_naquadah"))
                .ingot(5).fluid()
        ...
        LowGradeHypogen = new Material.Builder(GregitasCore.id("low_grade_hypogen"))
                .ingot(5)
        ...
        HighGradeHypogen = new Material.Builder(GregitasCore.id("high_grade_hypogen"))
                .ingot(5)
                .fluid(FluidStorageKeys.LIQUID, new FluidBuilder().temperature(16100))
                .fluid(FluidStorageKeys.MOLTEN, FluidState.LIQUID)
        ...
        WeaponsGradeHypogen = new Material.Builder(GregitasCore.id("weapons_grade_hypogen"))
                .ingot(6)
                .fluid(FluidStorageKeys.LIQUID, new FluidBuilder().temperature(16100))
                .fluid(FluidStorageKeys.MOLTEN, FluidState.LIQUID)
        ...
        InfinityMatter = new Material.Builder(GregitasCore.id("infinity_matter"))
                .ingot(7).fluid()
        ...
        Time = new Material.Builder(GregitasCore.id("time"))
                .element(GregitasElements.Time)
                .buildAndRegister();


        AllTheModium = new Material.Builder(GregitasCore.id("allthemodium"))
                .ingot(6).fluid()
        ...
        Unobtainium = new Material.Builder(GregitasCore.id("unobtainium"))
                .ingot(7).fluid()
        ...
        Certus = new Material.Builder(GregitasCore.id("certus"))
                .gem()
