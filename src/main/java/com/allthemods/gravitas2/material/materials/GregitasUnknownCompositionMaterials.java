...
public class GregitasUnknownCompositionMaterials {
    ...
    public static void init() {
        ...
        RawHypogen = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("raw_hypogen"))
                        .fluid()
                        .color(0xab6527)
        );

        DirtyHypogen = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("dirty_hypogen"))
                        .fluid()
                        .color(0xc9893a)
        );

        DirtyHypogenSolution = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("dirty_hypogen_solution"))
                        .fluid()
                        .color(0xc9b63a)
        );

        PurifiedHypogenSolution = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("purified_hypogen_solution"))
                        .fluid()
                        .color(0xe39714)
        );

        ImpureHypogenSolution = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("impure_hypogen_solution"))
                        .fluid()
                        .color(0xe69e10)
        );

        AcidicPurifiedHypogenSolution = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("acidic_purified_hypogen_solution"))
                        .fluid()
                        .color(0xed7e1c)
        );

        AcidicImpureHypogenSolution = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("acidic_impure_hypogen_solution"))
                        .fluid()
                        .color(0xeda71c)
        );

        WeaponsGradeHypogenSolution = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("weapons_grade_hypogen_solution"))
                        .fluid()
                        .color(0xe33714)
        );

        PurifiedHypogenWaste = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("purified_hypogen_waste"))
                        .fluid()
                        .color(0xede20c)
        );

        ImpureHypogenWaste = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("impure_hypogen_waste"))
                        .fluid()
                        .color(0xd8ed1c)
        );
        ...
        InfinityMatterPrecursor = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("infinity_matter_precursor"))
                        .fluid()
                        .color(0xe39e14)
        );

        ImpureInfinityMatter = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("impure_infinity_matter"))
                        .plasma()
                        .color(0xdcebbe)
        );

        ReactiveInfinityMatter = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("reactive_infinity_matter"))
                        .fluid()
                        .color(0xbeebe0)
        );

        SpacetimeJunk = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("spacetime_junk"))
                        .dust()
                        .color(0x734b6c)
        );

        Igneous = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("igneous"))
                        .dust()
                        .color(0xbebebe)
        );

        BioMedium = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("bio_medium"))
                        .fluid()
                        .color(0xb5ba54)
        );

        Sculk = GregitasMaterials.registerMaterial(
                new Material.Builder(GregitasCore.id("sculk"))
                        .fluid().dust()
