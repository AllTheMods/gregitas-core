...
public interface IPressureContainer {
    ...
    default boolean isNormalPressure() {
        return Math.abs(getPressure() - GregitasConstants.EARTH_PRESSURE) < PRESSURE_TOLERANCE;
    }
    ...
    default boolean isVacuum() {
        return getPressure() < GregitasConstants.EARTH_PRESSURE - PRESSURE_TOLERANCE;
    }
    ...
    IPressureContainer EMPTY = new IPressureContainer() {
        ...
        public double getMinPressure() {
            return GregitasConstants.EARTH_PRESSURE / 2;
        }
