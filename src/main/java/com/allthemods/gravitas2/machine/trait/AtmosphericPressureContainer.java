...
public class AtmosphericPressureContainer extends NotifiablePressureContainer {
     ...
     */
    public AtmosphericPressureContainer(MetaMachine metaTileEntity, IO io, double volume) {
        super(metaTileEntity, io, GregitasConstants.EARTH_PRESSURE * 0.9, GregitasConstants.EARTH_PRESSURE * 1.1, volume);
    }
